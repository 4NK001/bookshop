...
<head>
    ...
    <style>
        ...
        .donation h4, .donation h5, .donation time {
            margin: 0;
            font-size: 1.2em;
            color: #007bff;
        }
        ...
        .donation-form input[type="number"], .donation-form input[type="submit"] {
            padding: 10px;
            margin: 10px 0;
            border-radius: 5px;
...
<section class="donation-section">
    ...
    <?php
    // Fetch donations for the specific book
    $sql = "SELECT tbl_donation.userId, tbl_donation.amount, tbl_donation.date, tbl_reader.name 
    FROM tbl_donation 
    INNER JOIN tbl_reader ON tbl_donation.userId = tbl_reader.userid 
    WHERE tbl_donation.bookId = '$bookId'";
