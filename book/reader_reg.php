...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO tbl_reader (name,email) VALUES ('$name','$email')";
        if (mysqli_query($conn, $sql)) {
            // Insert into tbl_login with password
            ...
            $mail->setFrom('your mail', 'passcode');
            ...
            $mail->Body = "Dear $name,\n\n" . 
                "Congratulations! Your Reader registration was successful.\n\n" .
